...
log_b <- function(x, base) {
    .Call('_NWTMasterSample_log_b', PACKAGE = 'NWTMasterSample', x, base)
}
...
HaltonSeq <- function(k, base, n) {
    .Call('_NWTMasterSample_HaltonSeq', PACKAGE = 'NWTMasterSample', k, base, n)
}
...
GetBoxIndices <- function(lxy, base, J) {
    .Call('_NWTMasterSample_GetBoxIndices', PACKAGE = 'NWTMasterSample', lxy, base, J)
}
...
SolveCongruence <- function(A, base, J) {
    .Call('_NWTMasterSample_SolveCongruence', PACKAGE = 'NWTMasterSample', A, base, J)
}
